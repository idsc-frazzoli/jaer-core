...
public abstract class SPIConfigValue extends AbstractConfigValue {
  ...
  public SPIConfigValue(final String configName, final String toolTip, final AEChip chip, final short moduleAddr, final short paramAddr, final int numBits) {
  ...
  public String toString() {
    return String.format("SPIConfigValue {configName=%s, prefKey=%s, moduleAddr=%d, paramAddr=%d, numBits=%d}", getName(), getPreferencesKey(), getModuleAddr(),
        getParamAddr(), getNumBits());
  }
