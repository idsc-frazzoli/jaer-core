...
public class PanTiltControlDynamixel extends PanTiltControl {
  ...
  public void move(byte ID, short pos, short speed) {
    try {
      ...
      if (index < 0)
        index = 0;
      String strPanTilt = "HEX FF FF" + " " + java.lang.Integer.toHexString(ID) + " " + java.lang.Integer.toHexString(Length) + " "
          + java.lang.Integer.toHexString(Instruction) + " " + java.lang.Integer.toHexString(WriteAddress) + " " + java.lang.Integer.toHexString(posH) + " "
          + java.lang.Integer.toHexString(posL) + " " + java.lang.Integer.toHexString(speedH) + " " + java.lang.Integer.toHexString(speedL) + " "
