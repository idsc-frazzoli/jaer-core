...
public class DavisFrameAviWriter extends AbstractAviWriter {
  ...
  public DavisFrameAviWriter(AEChip chip) {
    ...
    setPropertyTooltip("saveAVIFileAs",
        "Opens the output file. The AVI file is in RAW format with pixel values 0-255 coming from ApsFrameExtractor displayed frames, which are offset and scaled by it.");
  ...
  synchronized public void propertyChange(PropertyChangeEvent evt) {
    if ((aviOutputStream != null && isWriteEnabled()) && (evt.getPropertyName() == AEFrameChipRenderer.EVENT_NEW_FRAME_AVAILBLE)
