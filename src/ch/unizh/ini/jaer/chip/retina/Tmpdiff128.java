...
public class Tmpdiff128 extends AETemporalConstastRetina implements Serializable {
  ...
  /** the event extractor for Tmpdiff128. Tmpdiff128 has two polarities 0 and 1. Here the polarity is flipped by the extractor so that the raw polarity 0
   * becomes 1
  ...
  public class Biasgen extends net.sf.jaer.biasgen.Biasgen implements ChipControlPanel, DVSTweaks {
    ...
    public Biasgen(Chip chip) {
      ...
      getPotArray().addPot(new IPot(this, "cas", 11, IPot.Type.CASCODE, IPot.Sex.N, 0, 2, "Photoreceptor cascode")); // first to be loaded, at end of shift
                                                                                                                     // register
      ...
      getPotArray().addPot(pr = new IPot(this, "Pr", 0, IPot.Type.NORMAL, IPot.Sex.P, 0, 1, "Photoreceptor")); // this is at start of shift register, load it
                                                                                                               // last
      // // test
