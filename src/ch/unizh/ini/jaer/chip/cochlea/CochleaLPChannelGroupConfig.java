...
public class CochleaLPChannelGroupConfig extends CochleaLPChannelConfig {
  private final List<CochleaChannelConfig> cochleaChannels;

  public CochleaLPChannelGroupConfig(final String configName, final String toolTip, final List<CochleaChannelConfig> cochleaChannels, AEChip chip) {
  ...
  public void loadPreference() {
    int nFields = CochleaLPChannelConfig.getFieldsNumber();
