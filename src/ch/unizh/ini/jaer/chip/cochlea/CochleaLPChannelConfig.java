...
public class CochleaLPChannelConfig extends CochleaChannelConfig {
  ...
  static {
    ...
    CHANNEL_FIELDS[0] = new MultiBitValue(1, 19, "Comparator self-oscillation enable. i.e. spike generation enable 1 bit, select to turn on");
    // delayCapConfigADM
    ...
    // attenuatorConfig
    CHANNEL_FIELDS[4] = new MultiBitValue(3, 8, "Attenuator configuration. Attenuation level control 3 bits, 8 levels, 7 is no attenuation, 0 is -18dB");
    // qTuning
