...
public class CochleaTow4EarChannelConfig extends CochleaChannelConfig {
  ...
  static {
    ...
    CHANNEL_FIELDS[0] = new MultiBitValue(1, 19, "Clear = Adds 0.5X more leak current for neurons 0-1");
    ...
    CHANNEL_FIELDS[2] = new MultiBitValue(1, 15, "Clear = Adds 0.5X more leak current for neurons 2-3");
    ...
    // Double leak current
    CHANNEL_FIELDS[4] = new MultiBitValue(1, 11, "Double leak current for all 4 neurons. nQ3=0 adds 1X more leak current to neuron");
    // Diff1
    CHANNEL_FIELDS[5] = new MultiBitValue(3, 8, "Diff1. nQ0=0 adds 25fF to feedback branch, nQ1=0 adds 33.3fF to FB branch, nQ2=0 adds 100fF to FB branch");
    // qTuning
    CHANNEL_FIELDS[6] = new MultiBitValue(3, 5, "Gain for SOS. Q tuning for SO. Q5, Q6, Q7 adds one xtor on the other leg of diffpair. Increases Q");
    CHANNEL_FIELDS[7] = new MultiBitValue(1, 4, "Gain for SOS. Q tuning for SO. nQ4 picks chain with 1 xtor in series. Decreases Q");
    CHANNEL_FIELDS[8] = new MultiBitValue(1, 3, "Gain for SOS. Q tuning for SO. nQ3 picks chain with 2 xtor in series. Decreases Q");
    CHANNEL_FIELDS[9] = new MultiBitValue(1, 2, "Gain for SOS. Q tuning for SO. nQ2 picks chain with 3 xtor in series. Decreases Q");
    CHANNEL_FIELDS[10] = new MultiBitValue(1, 1, "Gain for SOS. Q tuning for SO. nQ1 picks chain with 4 xtor in series. Decreases Q");
    CHANNEL_FIELDS[11] = new MultiBitValue(1, 0, "Gain for SOS. Q tuning for SO. nQ0 picks chain with 5 xtor in series. Decreases Q");
  }
