...
public final class CochleaLPControlPanel extends AbstractChipControlPanel {
  ...
  public CochleaLPControlPanel(final CochleaLP chip) {
    ...
    CochleaLPChannelGroupConfig globalChanControl = new CochleaLPChannelGroupConfig("Global", "Global control for all cochlea channels",
        getBiasgen().cochleaChannels, chip);
