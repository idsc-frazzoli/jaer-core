...
public class DavisAutoShooter extends EventFilter2D implements FrameAnnotater {
  ...
  public DavisAutoShooter(final AEChip chip) {
    ...
    setPropertyTooltip(rate, "shootFramesWhenDVSEventRateBelowThreshold",
        "only turn on APS frame capture when DVS event rate is below eventRateThresholdHz (disables all other frame capture modes)");
