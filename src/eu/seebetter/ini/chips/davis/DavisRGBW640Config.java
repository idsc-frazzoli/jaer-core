...
public class DavisRGBW640Config extends DavisTowerBaseConfig {
  public DavisRGBW640Config(final Chip chip) {
    ...
    // VDAC biases
    ipots.addPot(
        new TowerOnChip6BitVDAC(this, "ApsCasBpc", 0, 0, "N-type cascode for protecting drain of DVS photoreceptor log feedback FET from APS transients"));
    ipots.addPot(new TowerOnChip6BitVDAC(this, "OVG1Lo", 1, 0, "Logic low level of the overflow gate in the DAVIS pixel if it's configured as adjustable"));
    ipots.addPot(new TowerOnChip6BitVDAC(this, "OVG2Lo", 2, 0, "Logic low level of the overflow gate in the APS pixel if it's configured as adjustable"));
    ...
    ipots.addPot(new TowerOnChip6BitVDAC(this, "VTestADC", 5, 0, "A fixed voltage to test the on-chip ADC if it's configured to test mode"));
    ...
    apsControlLocal.add(new SPIConfigInt("APS.Transfer_D", "Transfer time counter (3 in GS, 1 in RS).", CypressFX3.FPGA_APS, (short) 50, 16, 0, this));
