...
public class DavisConfig extends Biasgen implements DavisDisplayConfigInterface, DavisTweaks, ChipControlPanel {
  ...
  public DavisConfig(final Chip chip) {
    ...
    // Multiplexer module
    muxControl
        .add(new SPIConfigBit("Mux.ForceChipBiasEnable", "Force the chip's bias generator to be always ON.", CypressFX3.FPGA_MUX, (short) 3, false, this));
    muxControl.add(new SPIConfigBit("Mux.DropDVSOnTransferStall", "Drop DVS events when USB FIFO is full.", CypressFX3.FPGA_MUX, (short) 4, true, this));
    muxControl.add(new SPIConfigBit("Mux.DropAPSOnTransferStall", "Drop APS events when USB FIFO is full.", CypressFX3.FPGA_MUX, (short) 5, false, this));
    muxControl.add(new SPIConfigBit("Mux.DropIMUOnTransferStall", "Drop IMU events when USB FIFO is full.", CypressFX3.FPGA_MUX, (short) 6, false, this));
    muxControl.add(
        new SPIConfigBit("Mux.DropExtInputOnTransferStall", "Drop External Input events when USB FIFO is full.", CypressFX3.FPGA_MUX, (short) 7, true, this));
    muxControl.add(new SPIConfigInt("USB.EarlyPacketDelay", "Ensure a USB packet is committed at least every N x 125µs timesteps.", CypressFX3.FPGA_USB,
        (short) 1, 13, 8, this));
    ...
    dvsControl.add(new SPIConfigInt("DVS.AckDelayRow", "Delay Row AER ACK by this many cycles.", CypressFX3.FPGA_DVS, (short) 4, 4, 4, this));
    dvsControl.add(new SPIConfigInt("DVS.AckDelayColumn", "Delay Column AER ACK by this many cycles.", CypressFX3.FPGA_DVS, (short) 5, 4, 0, this));
    dvsControl.add(new SPIConfigInt("DVS.AckExtensionRow", "Extend Row AER ACK by this many cycles.", CypressFX3.FPGA_DVS, (short) 6, 4, 1, this));
    dvsControl.add(new SPIConfigInt("DVS.AckExtensionColumn", "Extend Column AER ACK by this many cycles.", CypressFX3.FPGA_DVS, (short) 7, 4, 0, this));
    dvsControl.add(new SPIConfigBit("DVS.WaitOnTransferStall", "On event FIFO full, wait to ACK until again empty if true, or just continue ACKing if false.",
        CypressFX3.FPGA_DVS, (short) 8, false, this));
    dvsControl.add(new SPIConfigBit("DVS.FilterRowOnlyEvents", "Filter out row-only events (y,y,y,...).", CypressFX3.FPGA_DVS, (short) 9, true, this));
    dvsControl.add(new SPIConfigBit("DVS.ExternalAERControl", "Don't drive AER ACK pin from FPGA (also must disable Event Capture).", CypressFX3.FPGA_DVS,
        (short) 10, false, this));
    // TODO: new boards only.
    dvsControl.add(new SPIConfigBit("DVS.FilterBackgroundActivity",
        "Filter background events using hardware filter. Only does something on cameras with large FPGA, such as the experimental large PCBs hosting Davis346 / Davis640 / CDAVIS development kits",
        CypressFX3.FPGA_DVS, (short) 29, false, this));
    dvsControl.add(new SPIConfigInt("DVS.FilterBackgroundActivityDeltaTime",
        "Hardware background events filter delta time (in µs). Only does something on cameras with large FPGA, such as the experimental large PCBs hosting Davis346 / Davis640 / CDAVIS development kits",
    ...
    apsControl.add(new SPIConfigBit("APS.ResetRead", "Do the reset read in addition to the signal read.", CypressFX3.FPGA_APS, (short) 5, true, this));
    apsControl.add(new SPIConfigBit("APS.WaitOnTransferStall", "On event FIFO full, pause and wait for free space. This ensures no APS pixels are dropped.",
        CypressFX3.FPGA_APS, (short) 6, true, this));
    globalShutter = new SPIConfigBit("APS.GlobalShutter", "Enable global shutter versus rolling shutter.", CypressFX3.FPGA_APS, (short) 8, true, this);
    ...
    apsFrameDelay = new SPIConfigInt("APS.FrameDelay", "Set delay time between frames (in µs).", CypressFX3.FPGA_APS, (short) 14, 20, 1000, this);
    apsControl.add(apsFrameDelay);
    apsControl.add(new SPIConfigInt("APS.ResetSettle", "Set reset settle time (in cycles).", CypressFX3.FPGA_APS, (short) 15, 5, 10, this));
    apsControl.add(new SPIConfigInt("APS.ColumnSettle", "Set column settle time (in cycles).", CypressFX3.FPGA_APS, (short) 16, 6, 30, this));
    apsControl.add(new SPIConfigInt("APS.RowSettle", "Set row settle time (in cycles).", CypressFX3.FPGA_APS, (short) 17, 5, 10, this));
    apsControl.add(new SPIConfigInt("APS.NullSettle", "Set null settle time (in cycles).", CypressFX3.FPGA_APS, (short) 18, 5, 3, this));
    ...
    imuControl.add(new SPIConfigBit("IMU.TempStandby", "Disable temperature measurement.", CypressFX3.FPGA_IMU, (short) 1, false, this));
    ...
    imuControl.add(new SPIConfigInt("IMU.DigitalLowPassFilter", "Digital low-pass filter configuration.", CypressFX3.FPGA_IMU, (short) 7, 3, 1, this));
    imuControl.add(new SPIConfigInt("IMU.AccelFullScale", "Accellerometer scale configuration.", CypressFX3.FPGA_IMU, (short) 8, 2, 2, this));
    ...
    extInControl.add(new SPIConfigBit("ExtInput.RunDetector", "Enable signal detector.", CypressFX3.FPGA_EXTINPUT, (short) 0, false, this));
    extInControl.add(
        new SPIConfigBit("ExtInput.DetectRisingEdges", "Emit special event if a rising edge is detected.", CypressFX3.FPGA_EXTINPUT, (short) 1, false, this));
    extInControl.add(
        new SPIConfigBit("ExtInput.DetectFallingEdges", "Emit special event if a falling edge is detected.", CypressFX3.FPGA_EXTINPUT, (short) 2, false, this));
    extInControl.add(new SPIConfigBit("ExtInput.DetectPulses", "Emit special event if a pulse is detected.", CypressFX3.FPGA_EXTINPUT, (short) 3, true, this));
    extInControl
        .add(new SPIConfigBit("ExtInput.DetectPulsePolarity", "Polarity of the pulse to be detected.", CypressFX3.FPGA_EXTINPUT, (short) 4, true, this));
    extInControl
        .add(new SPIConfigInt("ExtInput.DetectPulseLength", "Minimal length of the pulse to be detected.", CypressFX3.FPGA_EXTINPUT, (short) 5, 27, 60, this));
    // TODO: new boards only.
    extInControl.add(new SPIConfigBit("ExtInput.RunGenerator", "Enable signal generator (PWM-like).", CypressFX3.FPGA_EXTINPUT, (short) 7, false, this));
    extInControl.add(new SPIConfigBit("ExtInput.GenerateUseCustomSignal", "Use custom FPGA-internal signal, instead of PWM-like generator output.",
        CypressFX3.FPGA_EXTINPUT, (short) 8, false, this));
    extInControl.add(new SPIConfigBit("ExtInput.GeneratePulsePolarity", "Polarity of the generated pulse.", CypressFX3.FPGA_EXTINPUT, (short) 9, false, this));
    final SPIConfigInt extOutPulseInterval = new SPIConfigInt("ExtInput.GeneratePulseInterval", "Time interval between consecutive pulses.",
        CypressFX3.FPGA_EXTINPUT, (short) 10, 27, 60, this);
    extInControl.add(extOutPulseInterval);
    final SPIConfigInt extOutPulseLength = new SPIConfigInt("ExtInput.GeneratePulseLength", "Time length of a pulse.", CypressFX3.FPGA_EXTINPUT, (short) 11, 27,
        30, this);
    extInControl.add(extOutPulseLength);
    final SPIConfigInt extOutPulseFrequency = new SPIConfigInt("ExtInput.GeneratePulseFrequency", "Frequency (in Hz) of the pulse to be generated.",
        CypressFX3.FPGA_EXTINPUT, (short) 255, 27, 1_000_000, this);
    extInControl.add(extOutPulseFrequency);
    final SPIConfigInt extOutPulseDutyCycle = new SPIConfigInt("ExtInput.GeneratePulseDutyCycle", "Duty cycle % of the pulse to be generated.",
        CypressFX3.FPGA_EXTINPUT, (short) 255, 27, 50, this);
    ...
    chipControl.add(new SPIConfigBit("Chip.ResetCalibNeuron", "Turn off the integrate and fire calibration neuron (bias generator).", CypressFX3.FPGA_CHIPBIAS,
        (short) 136, true, this));
    chipControl.add(new SPIConfigBit("Chip.TypeNCalibNeuron",
        "Make the integrate and fire calibration neuron configured to measure N type biases; otherwise measures P-type currents.", CypressFX3.FPGA_CHIPBIAS,
        (short) 137, false, this));
    chipControl.add(new SPIConfigBit("Chip.ResetTestPixel", "Keep the text pixel in reset.", CypressFX3.FPGA_CHIPBIAS, (short) 138, true, this));
    ...
    dvsRun.addObserver(new Observer() {
      @Override
      public void update(final Observable o, final Object arg) {
        getSupport().firePropertyChange(DavisDisplayConfigInterface.PROPERTY_CAPTURE_EVENTS_ENABLED, null, ((SPIConfigBit) o).isSet());
      }
    });
    apsRun.addObserver(new Observer() {
      @Override
      public void update(final Observable o, final Object arg) {
        getSupport().firePropertyChange(DavisDisplayConfigInterface.PROPERTY_CAPTURE_FRAMES_ENABLED, null, ((SPIConfigBit) o).isSet());
      }
    });
    globalShutter.addObserver(new Observer() {
      @Override
      public void update(final Observable o, final Object arg) {
        getSupport().firePropertyChange(DavisDisplayConfigInterface.PROPERTY_GLOBAL_SHUTTER_MODE_ENABLED, null, ((SPIConfigBit) o).isSet());
      }
    });
  ...
  public JPanel buildControlPanel() {
    ...
    combinedBiasShiftedSourcePanel.add(new JLabel("<html>Low-level control of on-chip bias currents and voltages. <p>These are only for experts!"));
  ...
  public class VideoControl extends Observable implements Observer, HasPreference, HasPropertyTooltips {
    ...
    public DavisVideoContrastController getContrastContoller() {
      ...
      throw new RuntimeException(
          "Cannot return a video contrast controller for the image output for the current renderer, which is " + ((AEChip) getChip()).getRenderer());
    }
  }
  ...
  static final protected AddressedIPotCF addAIPot(final AddressedIPotArray potArray, final Biasgen biasgen, final String s) {
    ...
    try {
      ...
      if (t.countTokens() != 5) {
        throw new Error(
            "only " + t.countTokens() + " tokens in pot " + s + "; use , to separate tokens for name,address,sex,type,tooltip\nsex=n|p, type=normal|cascode");
      }
