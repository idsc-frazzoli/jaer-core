...
public class IMUSample {
  ...
  private static float accelSensitivityScaleFactorGPerLsb = 1f / 8192, gyroSensitivityScaleFactorDegPerSecPerLsb = 1f / 65.5f,
      temperatureScaleFactorDegCPerLsb = 1f / 340, temperatureOffsetDegC = 35;
  /** Full scale values */
   ...
   * null ordinarily, or a previous exception if the
  ...
  public static IMUSample constructFromAEPacketRaw(final AEPacketRaw packet, final int start, final IncompleteIMUSampleException previousException)
  ...
  public String toString() {
    return String.format(
        ...
        getSensorRaw(IMUSampleType.ax), getSensorRaw(IMUSampleType.ay), getSensorRaw(IMUSampleType.az), getSensorRaw(IMUSampleType.gx),
