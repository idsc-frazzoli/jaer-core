...
public class Davis208PixelParadeConfig extends DavisTowerBaseConfig {
  public Davis208PixelParadeConfig(final Chip chip) {
    ...
    // VDAC biases
    ipots.addPot(
        new TowerOnChip6BitVDAC(this, "apsOverflowLevel", 0, 0, "Sets reset level gate voltage of APS reset FET to prevent overflow causing DVS events"));
    ipots
        .addPot(new TowerOnChip6BitVDAC(this, "ApsCas", 1, 0, "n-type cascode for protecting drain of DVS photoreceptor log feedback FET from APS transients"));
    ...
    ipots.addPot(new TowerOnChip6BitVDAC(this, "RefSsbxBv", 7, 0, "Set OffsetBns, the shifted source bias voltage of the pre-amplifier with VDAC"));
    // CoarseFine biases
    ...
    DavisConfig.addAIPot(ipots, this, "RefSsbxBn,30,n,normal,Set OffsetBns the shifted source bias voltage of the pre-amplifier with NBias");
    ...
    chipControlLocal.add(new SPIConfigBit("Chip.SelPreAmpAvgxD", "If 1, connect PreAmpAvgxA to calibration neuron, if 0, commongate.", CypressFX3.FPGA_CHIPBIAS,
        (short) 145, false, this));
    chipControlLocal
        .add(new SPIConfigBit("Chip.SelBiasRefxD", "If 1, select Nbias Blk1N, if 0, VDAC VblkV2.", CypressFX3.FPGA_CHIPBIAS, (short) 146, true, this));
    chipControlLocal
        .add(new SPIConfigBit("Chip.SelSensexD", "If 0, hook refractory bias to Vdd (unselect).", CypressFX3.FPGA_CHIPBIAS, (short) 147, true, this));
    chipControlLocal
        .add(new SPIConfigBit("Chip.SelPosFbxD", "If 0, hook refractory bias to Vdd (unselect).", CypressFX3.FPGA_CHIPBIAS, (short) 148, true, this));
    chipControlLocal.add(new SPIConfigBit("Chip.SelHpxD", "If 0, hook refractory bias to Vdd (unselect).", CypressFX3.FPGA_CHIPBIAS, (short) 149, true, this));
