...
public class DavisVideoContrastController extends Observable {
  ...
  public float autoContrastControlTimeConstantMs = prefs.getFloat("DavisVideoContrastController.autoContrastControlTimeConstantMs", 1000f);
  ...
  public String toString() {
    ...
    return String.format("DavisVideoContrastController: minAvg=%-10.1f, maxAvg=%-10.1f, autoContrast=%-10.3f autoBrightness=%-10.3f", minmax.x, minmax.y,
        autoContrast, autoBrightness);
  }
