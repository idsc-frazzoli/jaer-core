...
public class DavisTowerBaseConfig extends DavisConfig {
  public DavisTowerBaseConfig(final Chip chip) {
    ...
    apsControlLocal
        .add(new SPIConfigBit("APS.UseInternalADC", "Use the on-chip ADC instead of the external TI ADC.", CypressFX3.FPGA_APS, (short) 34, true, this));
    ...
    apsControlLocal.add(new SPIConfigInt("APS.SampleSettle", "Sample hold time (in cycles).", CypressFX3.FPGA_APS, (short) 36, 6, 30, this));
    apsControlLocal.add(new SPIConfigInt("APS.RampReset", "Ramp reset time (in cycles).", CypressFX3.FPGA_APS, (short) 37, 6, 10, this));
    apsControlLocal.add(new SPIConfigBit("APS.RampShortReset", "Only go through half the ramp for reset read.", CypressFX3.FPGA_APS, (short) 38, false, this));
    apsControlLocal
        .add(new SPIConfigBit("APS.ADCTestMode", "Put all APS pixels in permanent reset for ADC testing.", CypressFX3.FPGA_APS, (short) 39, false, this));
    ...
    chipControlLocal.add(new SPIConfigBit("Chip.TestADC", "Pass ADC Test Voltage to internal ADC instead of pixel voltage.", CypressFX3.FPGA_CHIPBIAS,
