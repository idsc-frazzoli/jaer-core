...
public class AEConstants {
   ...
   * The timestamp is a signed 32-bit int value. If the tick is 1us, the timestamp wraps every int32 us, which is about 4295 seconds which is 71 minutes. Time
   * is negative, then positive, then negative again.
