...
/** A raw data packet with network source / destination information. Currently used to store the source addresses and starting event indices for data from UDP
 * clients.
 *
 * @author tobi */
