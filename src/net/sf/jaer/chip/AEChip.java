...
public class AEChip extends Chip2D {
  ...
  protected List<Class> defaultEventFilters = new ArrayList<>();
  ...
  public List<Class> getDefaultEventFilterClasses() {
  ...
  public List<String> getDefaultEventFilterClassNames() {
  ...
  public AEChip() {
    ...
    setCanvas(new ChipCanvas(this)); // note that we need to do this again even though Chip2D did it, because the AEChipRenderer here shadows the Chip2D
                                     // renderer and the renderer will be returned null, preventing installation of mouse listeners
  ...
  public void writeAdditionalAEFileOutputStreamHeader(AEFileOutputStream os) throws IOException, BackingStoreException {
    ...
    ByteArrayOutputStream bos = new ByteArrayOutputStream(200000); // bos to hold preferences XML as byte array, tobi sized prefs as 186kB of text and about
                                                                   // 2200 lines for set of preferences at INI
    getPrefs().exportSubtree(bos);
    bos.flush();
    os.writeHeaderLine("Start of Preferences for this AEChip (search for \"End of Preferences\" to find end of this block)"); // write header to AE data file
                                                                                                                              // for prefs
