...
public class AEOutputStream extends DataOutputStream {
  ...
  /** Writes the raw (device) address-event packet out as sequence of address/timestamp's, just as they came as input from the device. The notion of a packet is
   * discarded
