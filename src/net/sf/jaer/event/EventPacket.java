...
public class EventPacket<E extends BasicEvent> implements /* EventPacketInterface<E>, */ Cloneable, Iterable<E> {
  ...
  public String toString() {
    ...
    final String s = "EventPacket #" + hashCode() + " holding " + getEventClass().getSimpleName() + " with size=" + sz + " capacity=" + capacity
        + " inputIterator=" + inputIterator + " outputIterator=" + outputIterator + " filteredOutCount=" + filteredOutCount;
    return s;
  }
  ...
  public final void setEventClass(final Class<? extends BasicEvent> eventClass) {
    ...
    try {
      ...
      EventPacket.log.warning("cannot get constructor for constructing Events for building EventPacket: exception=" + e.toString() + ", cause=" + e.getCause());
      e.printStackTrace();
    }
    initializeEvents();
  }
