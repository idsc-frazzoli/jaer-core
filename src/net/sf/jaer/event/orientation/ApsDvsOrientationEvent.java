...
public class ApsDvsOrientationEvent extends ApsDvsEvent implements OrientationEventInterface {
  ...
  public void copyFrom(BasicEvent src) {
    ...
    if (e instanceof ApsDvsOrientationEvent)
      this.orientation = ((ApsDvsOrientationEvent) e).orientation;
  }
  ...
  public byte getOrientation() {
    if (!isHasOrientation())
      throw new IllegalStateException("the event is flaged as not having an orientation!");
    return orientation;
  }
  ...
  @Override
  public void setHasOrientation(final boolean hasOrientation) {
