...
public class OrientationEvent extends PolarityEvent {
  ...
  public void copyFrom(BasicEvent src) {
    ...
    if (e instanceof OrientationEvent)
      this.orientation = ((OrientationEvent) e).orientation;
  }
  ...
  public static final UnitVector[] unitVectors = { new UnitVector(1, 0), new UnitVector(1, 1), new UnitVector(0, 1), new UnitVector(-1, 1), };
  // </editor-fold>
}
