...
public class SubclassFinder {
  ...
  public static class SubclassFinderWorker extends SwingWorker<ArrayList<ClassNameWithDescriptionAndDevelopmentStatus>, Object> {
    ...
    protected ArrayList<ClassNameWithDescriptionAndDevelopmentStatus> doInBackground() throws Exception {
      ...
      if (allClasses.isEmpty()) {
        log.warning("List of subclasses of " + superClassName
            + " is empty, is there something wrong with your classpath. Do you have \"compile on save\" turned on? (This option can break the SubclassFinder).");
      }
      int i = 0;
      ...
      allclassloop: for (String s : allClasses) {
        ...
        try {
          ...
          // TODO: Better way of handling Errors is needed. Most of them arent a problem, as they dont belong to jAER anyway. If that is the case we should
          // ignore, not log...
  ...
  public static ArrayList<String> findSubclassesOf(String superClassName, final ProgressMonitor progressMonitor) { // TODO this doesn't work, monitor bar does
                                                                                                                   // not update and just shows blank, even if
                                                                                                                   // this method is executed in a SwingWorker
                                                                                                                   // thread
