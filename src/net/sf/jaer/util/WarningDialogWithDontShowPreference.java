 ...
 * Note also how the Swing code is called in the AWT thread safely using SwingUtilities. A reference to the dialog must be kept so that it can be later used to
 * check
...
public class WarningDialogWithDontShowPreference extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(layout.createSequentialGroup().addComponent(dontShowAgainCheckBox).addContainerGap(328, Short.MAX_VALUE))
    ...
    layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
        layout.createSequentialGroup().addComponent(iconPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(dontShowAgainCheckBox)));
    pack();
  ...
  public static void main(String args[]) {
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        WarningDialogWithDontShowPreference dialog = new WarningDialogWithDontShowPreference(new javax.swing.JFrame(), true, "Test Warning",
            "<html>This is a <p>test warning message</html>");
