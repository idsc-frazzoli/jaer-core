...
/** Tests DVS latency by drawing boxes on the screen on display updates. A camera can image this display and if the output is recorded, the latency from screen
 * back
