    ...
    public void run() {
      while (true) {
        try {
          ...
          //// bos.write(b[i]);
          //// if(!showedWarning){
          //// StringBuilder sb=new StringBuilder("WARNING: Received command line contains at least one \"\\\" at position "+i+" - this backslash could be
          // interpreted as escape sequence; replace with \"/\" for file separation:\n"+new String(b));
          //// for(int j=0;j<i;j++){
          //// sb.append(" ");
          //// }
          //// sb.append("^");
