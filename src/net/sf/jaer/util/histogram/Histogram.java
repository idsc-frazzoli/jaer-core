...
public interface Histogram {
   ...
   * @param resolution Defines the width of the drawing in GL drawing units. I.e. for chip displays it is in chip pixels when drawing with ChipCanvas using
   * default scaling of chip pixels. The number of drawn bins is determined from this resolution by dividing the number of bins by the resolution; e.g. if there
   * are 1000 bins and the resolution is 100 then 10 bins will be drawn.
