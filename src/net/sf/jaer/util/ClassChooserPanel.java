...
public class ClassChooserPanel extends javax.swing.JPanel {
  ...
  private List<ClassNameWithDescriptionAndDevelopmentStatus> availAllList;
  private List<String> revertCopy, defaultClassNames;
  ...
  public ClassChooserPanel(final Class subclassOf, List<String> classNames, List<String> defaultClassNames) {
    initComponents();
  ...
  public class FilterableListModel<ClassNameWithDescriptionAndDevelopmentStatus> extends DefaultListModel<ClassNameWithDescriptionAndDevelopmentStatus> {
    ...
    synchronized void filter(String s) {
      ...
      while (en.hasMoreElements()) { // add all elements that should be filtered out
        ...
        if ((ds != null)
            && (ds.value().equals(DevelopmentStatus.Status.Stable) || (includeExperimental && ds.value().equals(DevelopmentStatus.Status.Experimental)))) {
  ...
  private void initComponents() {
    ...
    availClassPanelLayout
        .setHorizontalGroup(
            availClassPanelLayout
                .createParallelGroup(
                    javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(
                    availClassPanelLayout.createSequentialGroup().addContainerGap()
                        .addGroup(
                            availClassPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(availClassPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(availClassPanelLayout.createSequentialGroup().addComponent(onlyStableCB)
                                    ...
                                    .addGroup(availClassPanelLayout.createSequentialGroup().addComponent(filterLabel)
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(clearFilterBut)
                                        .addGap(44, 44, 44))))));
    availClassPanelLayout
        .setVerticalGroup(availClassPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, availClassPanelLayout.createSequentialGroup().addContainerGap()
                .addGroup(availClassPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(filterLabel)
                    .addComponent(availFilterTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(clearFilterBut))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(availClassPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(onlyStableCB)
                    .addComponent(includeDescriptionCB))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(includeExperimentalCB)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(availClassDesciptionPanel).addContainerGap()));
    ...
    chosenClassPanelLayout.setHorizontalGroup(chosenClassPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jScrollPane3,
        javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE));
    chosenClassPanelLayout.setVerticalGroup(chosenClassPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jScrollPane3));
    ...
    descPanelLayout.setHorizontalGroup(descPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(descPanelLayout
        .createSequentialGroup().addGap(2, 2, 2)
        .addGroup(descPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                descPanelLayout.createSequentialGroup().addComponent(ClassDescSP, javax.swing.GroupLayout.DEFAULT_SIZE, 642, Short.MAX_VALUE).addGap(2, 2, 2))
            .addGroup(descPanelLayout.createSequentialGroup()
                .addGroup(descPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(devlStatusLbl).addComponent(ClassNameLbl,
                ...
                .addContainerGap()))));
    descPanelLayout.setVerticalGroup(descPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(descPanelLayout.createSequentialGroup()
            .addComponent(ClassDescSP, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            .addGroup(descPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(devlStatusLbl).addComponent(develStatusTF,
                javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGap(5, 5, 5).addGroup(descPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(ClassNameLbl).addComponent(
                ClassNameTF, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))));
    ...
    jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup()
        ...
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(defaultsButton)));
    javax.swing.GroupLayout layout = new javax.swing.GroupLayout(this);
    this.setLayout(layout);
    layout
        .setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
            layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
