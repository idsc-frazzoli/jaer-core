...
public class WindowSaver implements AWTEventListener {
  ...
  public void loadSettings(final JFrame frame) throws IOException {
    ...
    //// GraphicsDevice[] gs=ge.getScreenDevices(); // TODO it could be that remote session doesn't show screen that used to be used. Should check that we are
    // not offscreen. Otherwise registy edit is required to show window!
    // if (ge != null) {
    // GraphicsDevice gd = ge.getDefaultScreenDevice();
    //// } // TODO it could be that remote session doesn't show screen that used to be used. Should check that we are not offscreen. Otherwise registy edit is
