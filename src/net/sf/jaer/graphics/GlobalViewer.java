...
public class GlobalViewer extends javax.swing.JFrame {
  ...
  public final List<AEViewer.Ambassador> aeviewers = new ArrayList<>();
  public final List<DisplayWriter> inputDisplays = new ArrayList<>();
  public final List<DisplayWriter> internalDisplays = new ArrayList<>();
  List<PacketStream> packetStreams = new ArrayList<>();
  ...
  // Methods -----------------------------------------
  public void addAllInputs(List<AEViewer> viewers) {
    packetStreams.clear();
  ...
  private int countPlayingViewers() {
    ...
    for (AEViewer.Ambassador v : aeviewers) {
      if ((v.getMode() == AEViewer.PlayMode.PLAYBACK) || (v.getMode() == AEViewer.PlayMode.LIVE)) {
        active_players++;
      }
    }
  ...
  public List<PacketStream> getInputStreams() {
    List arr = aeviewers;
    return arr;
  }
  ...
  void initComponents() {
    ...
    this.add(new JScrollPane(filterPanel, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER), BorderLayout.WEST);
    ...
    button.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        JOptionPane.showMessageDialog(new JFrame(),
            "This viewer allows you to view input from multiple source, " + "and dispatch them to filters with variable numbers of input "
                ...
                + "change default argument for JAERViewer constuctor to true.\n\n" + "Please report any problems/questions/comments to " + "peter.e" + mid
                + "nor@gmail.com");
      }
    });
    bottomBar.add(button);
