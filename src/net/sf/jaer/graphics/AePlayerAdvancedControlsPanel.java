...
public class AePlayerAdvancedControlsPanel extends javax.swing.JPanel implements PropertyChangeListener {
  ...
  private final Hashtable<Integer, JLabel> markTable = new Hashtable<Integer, JLabel>(); // lookup from slider position to label, given to slider to draw labels
                                                                                         // at markers
  ...
  public AePlayerAdvancedControlsPanel(AEViewer viewer) {
    ...
    initComponents();
    setAePlayer(viewer.getAePlayer()); // TODO double set needed because aePlayer is needed in initComponents and we still need to do more component binding in
                                       // setAePlayer
  ...
  private void initComponents() {
    ...
    jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 28, Short.MAX_VALUE));
    ...
    jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 70, Short.MAX_VALUE));
    jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 20, Short.MAX_VALUE));
    ...
    playbackModePanelLayout.setHorizontalGroup(playbackModePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(playbackModePanelLayout.createSequentialGroup().addContainerGap()
            .addGroup(playbackModePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(playbackModePanelLayout.createSequentialGroup()
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(msLabel).addGap(18, 18, 18)
                    .addComponent(packetSizeSpinner, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(playbackModePanelLayout.createSequentialGroup().addComponent(fixedTimeSliceButton)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(fixedPacketSizeButton)))
            .addGroup(playbackModePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(playbackModePanelLayout.createSequentialGroup().addGap(2, 2, 2).addComponent(realtimeButton)).addGroup(playbackModePanelLayout
                    .createSequentialGroup().addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(eventsLabel)))
            .addContainerGap(180, Short.MAX_VALUE)));
    playbackModePanelLayout
        .setVerticalGroup(
            playbackModePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(
                    playbackModePanelLayout.createSequentialGroup().addContainerGap()
                        .addGroup(playbackModePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(fixedTimeSliceButton)
                            .addComponent(fixedPacketSizeButton).addComponent(realtimeButton))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(playbackModePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(timesliceSpinner, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(msLabel)
                            .addComponent(packetSizeSpinner, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
