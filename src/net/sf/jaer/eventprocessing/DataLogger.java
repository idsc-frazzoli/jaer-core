...
public class DataLogger extends EventFilter2D {
  ...
  public DataLogger(AEChip chip) {
    ...
    setPropertyTooltip(params, "filenameTimestampEnabled",
        "adds a timestamp to the filename, but means rotation will not overwrite old data files and will eventually fill disk");
  ...
  synchronized public File startLogging() {
    ...
    String base = chip.getClass().getSimpleName();
