 ...
 * support.firePropertyChange("mapEventsToLearnedTopologyEnabled", this.mapEventsToLearnedTopologyEnabled, mapEventsToLearnedTopologyEnabled); // property, old
 * value, new value
...
public class FilterPanel extends javax.swing.JPanel implements PropertyChangeListener {
      ...
      for (Method method : methods) {
        ...
        if (method.getName().startsWith("doPress") && (method.getParameterTypes().length == 0) && (method.getReturnType() == void.class)) {
          for (Method releasedMethod : methods) {
            ...
            if (releasedMethod.getName().equals("doRelease" + suf) && (releasedMethod.getParameterTypes().length == 0)
  ...
  public void propertyChange(PropertyChangeEvent propertyChangeEvent) {
    if (propertyChangeEvent.getSource() == getFilter()) {
      if (propertyChangeEvent.getPropertyName().equals("selected")) {
        ...
        // log.info("propertyChangeEvent name="+propertyChangeEvent.getPropertyName()+" src="+propertyChangeEvent.getSource()+"
        // oldValue="+propertyChangeEvent.getOldValue()+" newValue="+propertyChangeEvent.getNewValue());
  ...
  private void initComponents() {
    ...
    org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(
        org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${controlsVisible}"),
        showControlsToggleButton, org.jdesktop.beansbinding.BeanProperty.create("selected"));
