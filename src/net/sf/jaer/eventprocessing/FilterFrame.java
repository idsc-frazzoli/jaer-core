...
public class FilterFrame<PanelType extends FilterPanel> extends javax.swing.JFrame implements PropertyChangeListener/* , WindowSaver.DontResize */ {
  // tobi commented out DontResize because the filter frame was extending below the bottom of screen, making it awkward to control properties for deep
  // implementations
  ...
  public FilterFrame(AEChip chip) {
    ...
    scrollPane.getVerticalScrollBar().setUnitIncrement(16); // from
  ...
  private void initComponents() {
    ...
    measurePerformanceCheckBoxMenuItem.setToolTipText(
        "Enables instrumentation of filter performance. Filter processing time statistics are printed to System.out. They appear in netbeans IDE console, for example, but not in built-in jAER console, which does not show System.out.");
    ...
    layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(layout.createSequentialGroup().addContainerGap()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(searchTF).addContainerGap())
    ...
    layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(scrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 499, Short.MAX_VALUE).addGap(0, 0, 0)));
    pack();
  ...
  private void loadMenuItemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_loadMenuItemActionPerformed
    ...
    String lastFilePath = prefs.get("FilterFrame.lastFile", defaultFolder); // TODO seems to be same as for biases, should default to filterSettings folder of
                                                                            // jAER
