...
public class SourceSynchronizer {
  List<AEViewer.Ambassador> viewers;
  Container panel;
  JLabel[] timeStampLabels;
  JLabel[] labelsOfDespair;

  public SourceSynchronizer(List<AEViewer.Ambassador> viewerList, JPanel pan) {
    viewers = viewerList;
    if (pan != null) {
      panel = pan;
    } else {
  ...
  public SourceSynchronizer(List<AEViewer.Ambassador> viewerlist) {
