...
abstract public class EventFilter2D extends EventFilter {
   ...
   * @param timestamp the timestamp to be checked. If this timestamp is greater than the nextUpdateTime (or has gone backwards, to handle rewinds), then the
   * UpdateMessage is sent.
