...
public class MedianTracker extends EventFilter2D implements FrameAnnotater {
  ...
  public MedianTracker(AEChip chip) {
    ...
    setPropertyTooltip("numStdDevsForBoundingBox",
        "Multiplier for number of std deviations of x and y distances from median for drawing and returning bounding box");
  }
