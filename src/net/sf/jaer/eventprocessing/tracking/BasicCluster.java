...
public class BasicCluster {
  ...
  public String toString() {
    return String.format("Cluster number=#%d numEvents=%d location(x,y)=(%d,%d) radius=%.1f mass=%.1f lifetime=%d visible=%s", getClusterNumber(), numEvents,
        (int) location.x, (int) location.y, radius, getMass(), getLifetime(), isVisible());
  }
