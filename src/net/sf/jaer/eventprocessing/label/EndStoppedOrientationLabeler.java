...
public class EndStoppedOrientationLabeler extends SimpleOrientationFilter {
  ...
  public EndStoppedOrientationLabeler(AEChip chip) {
    ...
    setPropertyTooltip(endstop, "minActivityDifference",
        "<html>min activity difference (fraction of pixels with recent events) betweeen <br> two sides of endstopped orientation cell to pass events");
    ...
    setPropertyTooltip(endstop, "probabilisitcFiltering",
        "orientation event is passed probabilisitcally based on measured activity ratio: 0 ratio difference=don't pass, 1 ratio difference=pass.");
  }
