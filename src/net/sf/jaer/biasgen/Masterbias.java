...
public class Masterbias extends Observable implements BiasgenPreferences {
  ...
  /** Observable event */
  public static final String EVENT_POWERDOWN = "powerDownEnabled", EVENT_INTERNAL_RESISTOR = "internalResistor", EVENT_EXTERNAL_RESISTOR = "externalResistor",
      EVENT_INTERNAL_RESISTOR_USED = "internalReisistorUsed", EVENT_TEMPERATURE_CHANGED = "temperatureChange";
