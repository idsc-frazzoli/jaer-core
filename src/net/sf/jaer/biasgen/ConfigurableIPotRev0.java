...
public class ConfigurableIPotRev0 extends IPot {
  ...
  public ConfigurableIPotRev0(Biasgen biasgen, String name, int shiftRegisterNumber, Type type, Sex sex, boolean lowCurrentModeEnabled, boolean enabled,
  ...
  static String KEY_BITVALUE = "BitValue", KEY_BUFFER_BITVALUE = "BufferBitValue", KEY_SEX = "Sex", KEY_TYPE = "Type", KEY_LOWCURRENT_ENABLED = "LowCurrent",
      KEY_ENABLED = "Enabled";
  static String SEP = ".";
