...
public class AddressedIPotCF extends AddressedIPot {
  ...
  public AddressedIPotCF(Biasgen biasgen, String name, int address, Type type, Sex sex, boolean lowCurrentModeEnabled, boolean enabled, int coarseValue,
    ...
    if (chip.getRemoteControl() != null) {
      ...
      chip.getRemoteControl().addCommandListener(this, String.format(SETSEX + "%s " + getEnumOptions(Sex.class), getName()),
          "Set the sex (N|P) of " + getName());
      chip.getRemoteControl().addCommandListener(this, String.format(SETTYPE + "%s " + getEnumOptions(Type.class), getName()),
          "Set the type of IPot " + getName());
      chip.getRemoteControl().addCommandListener(this, String.format(SETLEVEL + "%s " + getEnumOptions(CurrentLevel.class), getName()),
          "Set the current level of IPot " + getName());
      chip.getRemoteControl().addCommandListener(this, String.format(SETENABLED + "%s " + getEnumOptions(BiasEnabled.class), getName()),
          "Set the current level of IPot " + getName());
    }
  ...
  public int computeBinaryRepresentation() {
    ...
    ret |= computeBinaryInverse(coarseBitValue, numCoarseBits) << sh; // The coarse bits are reversed (this was a mistake) so we need to mirror them here before
                                                                      // we sent them.
  ...
  static String KEY_BITVALUE_COARSE = "BitValueCoarse", KEY_BITVALUE_FINE = "BitValueFine", KEY_SEX = "Sex", KEY_TYPE = "Type",
      KEY_LOWCURRENT_ENABLED = "LowCurrent", KEY_ENABLED = "Enabled";
  static String SEP = ".";
  ...
  public String toString() {
    return super.toString() + " Sex=" + getSex() + " Type=" + getType() + " enabled=" + isEnabled() + " lowCurrentModeEnabled=" + isLowCurrentModeEnabled()
        + " coarseBitValue=" + coarseBitValue + " fineBitValue=" + fineBitValue;
  }
