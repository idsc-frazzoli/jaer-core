...
public class BiasgenFrame extends javax.swing.JFrame implements UndoableEditListener {
  ...
  public boolean isModificationsSaved() {
    ...
    int ret = JOptionPane.showOptionDialog(getContentPane(), "Save modified biasgen settings?", "Save bias modifications?", JOptionPane.YES_NO_CANCEL_OPTION,
  ...
  private void exitMenuItemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_exitMenuItemActionPerformed
    ...
    int ret = JOptionPane.showOptionDialog(getContentPane(),
        "Are you sure you want to exit (this will kill JVM and thus matlab if running from within matlab)?", "Exit biasgen?", JOptionPane.YES_NO_CANCEL_OPTION,
        JOptionPane.WARNING_MESSAGE, null, options, options[1]);
    if (ret == JOptionPane.YES_OPTION) {
      biasgen.close();
      System.exit(0);
