...
public class BiasgenAboutDialog extends javax.swing.JDialog {
  ...
  private void initComponents() {// GEN-BEGIN:initComponents
    ...
    aboutLabel.setText(
        "<html> <center> <h1> Biasgen IPot Controller </h1> <p> The Institute of Neuroinformatics <p> Uni/ETH Zurich, Switzerland <p> <em> <a href=\"http://www.ini.unizh.ch/~tobi/\">http://www.ini.unizh.ch/~tobi/</a> </em> </center>");
 ...
 * made IntegrateFireCell gettter/setter methods for settings timeconstants and used those in simulation setup factory to set complex cell properties better.
 * (need to move this inside complex cell factory method)
 * 
