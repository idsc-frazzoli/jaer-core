...
abstract public class Pot extends Observable implements PreferenceChangeListener {
   ...
   * @return array of bytes to be sent, by convention values are ordered in big endian format so that byte 0 is the most significant byte and is sent first to
   * the hardware */
  ...
  public boolean equals(Object obj) {
    ...
    Pot pot = (Pot) obj;
    return pot.getName().equals(getName()) && (pot.getSex() == getSex()) && (pot.getType() == getType()) && (pot.getChipNumber() == getChipNumber())
