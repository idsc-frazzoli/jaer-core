 ...
 * @author tobi */
public class AddressedIPotSliderTextControl extends JPanel implements Observer, StateEditable {
   ...
   *
   * @param pot the pot */
  public AddressedIPotSliderTextControl(AddressedIPot pot) {
    this.pot = pot;
  ...
  public static boolean isCurrentEnabled() {
    return AddressedIPotSliderTextControl.valueEnabled;
  }

  public static void setCurrentEnabled(final boolean currentEnabled) {
    AddressedIPotSliderTextControl.valueEnabled = currentEnabled;
    prefs.putBoolean("IPotGUIControl.currentEnabled", currentEnabled);
  }

  public static boolean isSliderEnabled() {
    return AddressedIPotSliderTextControl.sliderEnabled;
  }

  public static void setSliderEnabled(final boolean sliderEnabled) {
    AddressedIPotSliderTextControl.sliderEnabled = sliderEnabled;
    prefs.putBoolean("IPotGUIControl.sliderEnabled", sliderEnabled);
  }

  static ArrayList<AddressedIPotSliderTextControl> allInstances = new ArrayList<AddressedIPotSliderTextControl>();

  public static void revalidateAllInstances() {
    for (AddressedIPotSliderTextControl c : allInstances) {
