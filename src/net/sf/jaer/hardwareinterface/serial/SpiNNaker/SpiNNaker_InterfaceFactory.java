...
public class SpiNNaker_InterfaceFactory extends javax.swing.JDialog implements HardwareInterfaceFactoryChooserDialog {
  ...
  private void initComponents() {
    ...
    jLabel4.setText(
        "<html>SpiNNaker sends UDP AER packets. <p> Currently, there is no control protocol to enable/disable or configure the SpiNNaker device via jAER.");
    ...
    layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(
            layout.createSequentialGroup().addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(cancelButton).addContainerGap())
