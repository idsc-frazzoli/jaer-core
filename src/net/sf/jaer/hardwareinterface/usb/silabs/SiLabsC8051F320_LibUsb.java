 ...
 * @author sweber */
public abstract class SiLabsC8051F320_LibUsb implements BiasgenHardwareInterface, AEMonitorInterface, ReaderBufferControl, USBInterface {
  ...
  public void setAEBufferSize(int size) {
    if ((size < 1000) || (size > 1000000)) {
      SiLabsC8051F320_LibUsb.log.warning("ignoring unreasonable aeBufferSize of " + size + ", choose a more reasonable size between 1000 and 1000000");
      return;
    }
  ...
  synchronized public void open() throws HardwareInterfaceException {
    ...
    if (LibUsb.getDeviceSpeed(retina) != LibUsb.SPEED_FULL) {
      SiLabsC8051F320_LibUsb.log.warning("Device is not operating at USB 2.0 High Speed, performance will be limited to about 300 keps");
    }
    try {
  ...
  synchronized public void sendVendorRequest(final byte request, final Byte value) throws HardwareInterfaceException {
    sendVendorRequest(request, value, (ByteBuffer) null, (IntBuffer) null);
  }

  synchronized public void sendVendorRequest(byte[] dataBuffer) throws HardwareInterfaceException {
  ...
  synchronized public void sendVendorRequest(final byte request, final Byte value, ByteBuffer dataBuffer, IntBuffer intBuffer)
