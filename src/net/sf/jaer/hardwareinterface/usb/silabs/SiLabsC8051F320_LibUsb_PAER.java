  ...
  private class PaerAEReader extends SilabsAEReader {
    ...
    public void setEnable(boolean enable) {
      ...
      if (enable == true) {
        ...
        usbTransfer = new USBTransferThread(super.driver.retinahandle, ENDPOINT_IN, LibUsb.TRANSFER_TYPE_BULK, new PaerAEReader.ProcessAEData(),
            getNumBuffers(), getFifoSize());
