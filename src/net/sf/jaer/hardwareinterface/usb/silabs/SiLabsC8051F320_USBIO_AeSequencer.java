...
public class SiLabsC8051F320_USBIO_AeSequencer implements UsbIoErrorCodes, PnPNotifyInterface, AESequencerInterface, USBInterface {
  ...
  public final static String GUID = CypressFX2.GUID; // "{7794C79A-40A7-4a6c-8A29-DA141C20D78C}"; // this GUID is for the devices in
                                                     // driverUSBIO_Tmpdiff128_USBAERmini2
  /** The vendor ID */
