...
public class CypressFX2EEPROM extends javax.swing.JFrame implements UsbIoErrorCodes, PnPNotifyInterface {
  ...
  private void initComponents() {
    ...
    jLabel2.setText(
        "<html>This panel will write a VID/PID/DID to the device EEPROM. The device must have firmware loaded already that can write the EEPROM. </html>");
    ...
    vidpiddidPanelLayout.setHorizontalGroup(vidpiddidPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(vidpiddidPanelLayout.createSequentialGroup()
            .add(vidpiddidPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                ...
                .add(vidpiddidPanelLayout.createSequentialGroup().add(writeVIDPIDDIDButton).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
    ...
    vidpiddidPanelLayout
        .setVerticalGroup(vidpiddidPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(org.jdesktop.layout.GroupLayout.TRAILING,
            vidpiddidPanelLayout.createSequentialGroup().addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).add(jLabel2)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(vidpiddidPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(writeVIDPIDDIDButton)
                    .add(VIDtextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 23, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(PIDtextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(DIDtextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .add(12, 12, 12)));
    ...
    jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(org.jdesktop.layout.GroupLayout.TRAILING,
        jPanel1Layout.createSequentialGroup().addContainerGap().add(writeEEPROMRadioButton)
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 293, Short.MAX_VALUE).add(writeRAMRadioButton).add(69, 69, 69).add(eraseButton)
            .add(18, 18, 18).add(downloadFirmwareButton).add(91, 91, 91)));
                ...
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING,
                        jPanel6Layout.createSequentialGroup()
                            ...
                            .add(18, 18, 18).add(chooseFileButton)))
                .add(jLabel1))
            .addContainerGap(7, Short.MAX_VALUE)));
    jPanel6Layout.setVerticalGroup(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(jPanel6Layout.createSequentialGroup().addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).add(jLabel1)
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
            .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                .add(filenameTextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                    org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(chooseFileButton))
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(jPanel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
    ...
    firmwareDownloadPanelLayout.setHorizontalGroup(firmwareDownloadPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(firmwareDownloadPanelLayout.createSequentialGroup().addContainerGap()
            .add(jPanel6, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 908, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .addContainerGap(115, Short.MAX_VALUE)));
    firmwareDownloadPanelLayout.setVerticalGroup(firmwareDownloadPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(firmwareDownloadPanelLayout.createSequentialGroup().add(jPanel6, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
            org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
    ...
    USBAERmini2panelLayout.setHorizontalGroup(USBAERmini2panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(USBAERmini2panelLayout.createSequentialGroup().add(monSeqCPLDFirmwareButton).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
            .add(monSeqFX2FirmwareButton).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(monSeqFX2FirmwareButtonJTAG)
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
            .add(jPanel4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 452, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .addContainerGap(118, Short.MAX_VALUE)));
    USBAERmini2panelLayout.setVerticalGroup(USBAERmini2panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(USBAERmini2panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(monSeqFX2FirmwareButton)
            .add(monSeqCPLDFirmwareButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE).add(monSeqFX2FirmwareButtonJTAG))
    ...
    jPanel7Layout.setHorizontalGroup(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(jPanel7Layout.createSequentialGroup().addContainerGap()
            .add(CPLDfilenameField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 791, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(18, 18, 18)
            .add(chooseCPLDFileButton).addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
    jPanel7Layout.setVerticalGroup(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(jPanel7Layout.createSequentialGroup().addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .add(jPanel7Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(CPLDfilenameField,
            ...
            CPLDDownloadPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(CPLDDownloadPanelLayout.createSequentialGroup()
                    .add(CPLDDownloadPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(CPLDDownloadPanelLayout.createSequentialGroup().add(328, 328, 328).add(downloadCPLDFirmwareButton))
                        .add(CPLDDownloadPanelLayout.createSequentialGroup().addContainerGap().add(jPanel7, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                            org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                    .addContainerGap(113, Short.MAX_VALUE)));
    CPLDDownloadPanelLayout.setVerticalGroup(CPLDDownloadPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(CPLDDownloadPanelLayout.createSequentialGroup()
            .add(jPanel7, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(downloadCPLDFirmwareButton).addContainerGap(12, Short.MAX_VALUE)));
    ...
    layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(layout.createSequentialGroup()
        .add(scanPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
            org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        .add(vidpiddidPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
            org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        .add(firmwareDownloadPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
            org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        .add(deviceIDPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
            org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        .add(USBAERmini2panel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
            org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(CPLDDownloadPanel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
            org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
    pack();
  ...
  private void chooseFileButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_chooseFileButtonActionPerformed
    ...
    FileFilter filter = new FileFilter() {
      ...
      public boolean accept(File f) {
        ...
        if (f.getName().toLowerCase().endsWith(".iic") || f.getName().toLowerCase().endsWith(".bix") || f.getName().toLowerCase().endsWith(".hex")
    ...
    Thread T = new Thread("Firmware eraser") {
      ...
      public void run() {
        try {
          ...
          JOptionPane.showMessageDialog(CypressFX2EEPROM.this, "EEPROM erase successful - unplug and replug the device to complete erase",
              "Firmware erase complete", JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception e) {
      ...
      public void run() {
        try {
          ...
          if (fIsBixFile) {
            ...
            JOptionPane.showMessageDialog(CypressFX2EEPROM.this,
  ...
  private void monSeqFX2FirmwareButtonJTAGActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_monSeqFX2FirmwareButtonJTAGActionPerformed
    ...
    int test = JOptionPane.showConfirmDialog(this,
        "CAUTION: Some of the boards built in Sevilla have an FX2 (instead of the FX2LP), which does not have enough RAM for this firmware. Please check if your device has an FX2LP. Device number of the FX2LP is CY7C68013A or 014A, FX2 is without A.",
        "FX2LP check", JOptionPane.OK_CANCEL_OPTION);
