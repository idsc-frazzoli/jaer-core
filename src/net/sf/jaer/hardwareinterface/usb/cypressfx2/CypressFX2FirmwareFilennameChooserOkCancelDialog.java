...
public class CypressFX2FirmwareFilennameChooserOkCancelDialog extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    infoLabel.setText(
        "<html>Choose the .bix firmware file you wish to download to this device.<p>These files are usually located in either the folder <em>devices/firmware/</em> or the package <em>net.sf.jaer.hardwareinterface.usb</em><html>");
        ...
        .setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(chooseButton).addComponent(cancelButton))))
                .addContainerGap()));
    ...
    layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(layout.createSequentialGroup().addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                .addComponent(filenameTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
  ...
  private class FirmwareFileFilter extends javax.swing.filechooser.FileFilter {
    ...
    public boolean accept(File f) {
      ...
      // if(s.endsWith(".hex")) return true; // we only download binaries uniformly in CypressFX2, not hex files which are handled separately. TODO fix this
      // handling
