 ...
 * @author tobi */
public class CypressFX2AddressedBiasgen extends CypressFX2 implements BiasgenHardwareInterface {
  ...
  protected CypressFX2AddressedBiasgen(int devNumber) {
    super(devNumber);
  }

  /* sets the powerdown input pin to the biasgenerator.
   * Chip may have been plugged in without being
   * powered up. To ensure the biasgen is powered up, a negative transition is necessary. This transistion is necessary to ensure the startup circuit starts up
   * the masterbias again.
   * 
