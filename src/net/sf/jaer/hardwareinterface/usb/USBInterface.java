...
public interface USBInterface extends HardwareInterface {
  ...
  /** return the string USB descriptors for the device. By USB convention, the first string is the manufactuer, the second is product, and the last is the
  ...
  /** @return DID (device ID). This is the firmware version number, not the serial number. A device may not set the firmware version number in it's descriptors.
   * Returns 0 then. DVS128
