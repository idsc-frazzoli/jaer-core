...
public class HardwareInterfaceFactory extends HashSet<Class> implements HardwareInterfaceFactoryInterface, PnPNotifyInterface {
  ...
  final public static Class[] factories = { SiLabs_USBIO_C8051F3xxFactory.class, USBIOHardwareInterfaceFactory.class, LibUsbHardwareInterfaceFactory.class,
      LibUsb3HardwareInterfaceFactory.class, UDPInterfaceFactory.class, eDVS128_InterfaceFactory.class, SpiNNaker_InterfaceFactory.class, };
  ...
  synchronized public void buildInterfaceList() {
    ...
    for (final Class factorie : HardwareInterfaceFactory.factories) {
      try {
        ...
        HardwareInterfaceFactory.log.warning(factorie + " has no instance() method but it needs to be a singleton of this form");
        e.printStackTrace();
