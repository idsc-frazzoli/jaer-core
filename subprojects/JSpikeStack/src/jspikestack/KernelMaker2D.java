...
public class KernelMaker2D {
  public enum Types {
    Gaussian, MexiHat, Hori, Vert
  };

  public enum KernelClass {
    GAUSSIAN, MEXIHAT, DIFFGAUSSIAN, EXPONENTIAL, PARABOLA, FLAT, RANDOM
  };

  public enum Scaling {
    FitToRange, FitAboutZero
  }

  public static KernelPair[] kernPairs = new KernelPair[] { new KernelPair(KernelClass.GAUSSIAN, Gaussian.class),
      new KernelPair(KernelClass.MEXIHAT, MexiHat.class), new KernelPair(KernelClass.DIFFGAUSSIAN, DiffGaussian.class),
      new KernelPair(KernelClass.PARABOLA, Parabola.class), new KernelPair(KernelClass.FLAT, Flat.class), new KernelPair(KernelClass.RANDOM, RandomKern.class),
