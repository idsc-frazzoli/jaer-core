...
public class Network<AxonType extends Axon> implements Serializable {
  ...
  public Network(Axon.AbstractFactory axonFac, Unit.AbstractFactory unitFac) { // plot=new NetPlotter(this);
  ...
  public void addToQueue(PSP ev) { // TODO: confirm timestamp monotonicity
    inputBuffer.add(ev);
  }
