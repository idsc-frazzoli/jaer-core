...
public class NetReader<NetType extends Network> implements Network.NetworkReader {
  ...
  public NetType copy() {
    ...
    // C:\Documents and Settings\Tobi\My Documents\jaer\host\java\subprojects\JSpikeStack\src\jspikestack\NetReader.java:139: type parameters of
    // <NetType>NetType cannot be determined; no unique maximal instance exists for type variable NetType with upper bounds NetType,jspikestack.SpikeStack
